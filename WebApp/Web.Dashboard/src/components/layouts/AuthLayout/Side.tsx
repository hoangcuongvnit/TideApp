...
const Side = ({ children, content, ...rest }: SideProps) => {
    return (
        <div className="grid lg:grid-cols-3 h-full">
            ...
            >
                ...
                <div>
                    ...
                    <p className="text-lg text-white opacity-80">
                        TideApp comes with a complete set of UI components
            ...
            <div className="col-span-2 flex flex-wrap justify-center items-center bg-white dark:bg-gray-800 max-h-screen overflow-y-auto py-8">
