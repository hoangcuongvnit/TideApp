...
const UsersTable = () => {
    ...
    const data = useAppSelector((state) => state.owner.reducers.users)
    const roles = useAppSelector((state) => state.owner.reducers.roles)
    const loading = useAppSelector((state) => state.owner.reducers.loading)
    ...
    const totalRecords = useAppSelector(
        (state) => state.owner.reducers.totalRecords
    )
