...
{
    /// <inheritdoc />
    public partial class BlogInitDB : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    PostReactionId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPostReaction", x => new { x.UserId, x.PostReactionId });
                    table.ForeignKey(
                        name: "FK_UserPostReaction_PostReaction_PostReactionId",
                        column: x => x.PostReactionId,
                        principalTable: "PostReaction",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserPostReaction_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPostReaction_PostReactionId",
