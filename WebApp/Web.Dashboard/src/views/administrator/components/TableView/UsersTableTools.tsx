...
const UsersTableTools = () => {
    ...
    return (
        <div className='md:flex items-center justify-between'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-1 xl:grid-cols-2 gap-1 mb-4'>
                <Button className='mr-4 hidden xl:block' size='sm' icon={<PiArrowsCounterClockwiseThin />} onClick={reload}>
